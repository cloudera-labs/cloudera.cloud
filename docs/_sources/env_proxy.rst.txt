...
.. title:: env_proxy -- Create, update, or destroy CDP Environment Proxies

env_proxy -- Create, update, or destroy CDP Environment Proxies
===============================================================
...
.. table::
   ...
   +-----------------+-----------------------+--------------------------------------------------------------------------------------+
   | **name**        |                       | The name of the proxy config                                                         |
   |                 |                       |                                                                                      |
   | |br|            |                       |                                                                                      |
   |                 |                       |                                                                                      |
   | ``str``         |                       |                                                                                      |
   ...
   | ``int``         |                       |                                                                                      |
   +-----------------+-----------------------+--------------------------------------------------------------------------------------+
   | **protocol**    | **Choices:**          | The protocol                                                                         |
   |                 |  - http               | Required when state=present                                                          |
   | |br|            |  - https              |                                                                                      |
   +-----------------+-----------------------+--------------------------------------------------------------------------------------+
   | **user**        |                       | The proxy user                                                                       |
   ...
   | ``str``         |                       |                                                                                      |
   +-----------------+-----------------------+--------------------------------------------------------------------------------------+
   | **state**       | **Choices:**          | The state of the proxy                                                               |
   |                 |  - **present** |larr| |                                                                                      |
   | |br|            |  - absent             |                                                                                      |
   +-----------------+-----------------------+--------------------------------------------------------------------------------------+
...
.. table::
   ...
   +-----------------------+----------------+---------------------------------------------------------------------------------------------------------------------+
   | **proxy**             | on success     | Details on the proxy                                                                                                |
   |                       |                |                                                                                                                     |
   | |br|                  |                |                                                                                                                     |
   |                       |                |                                                                                                                     |
   | ``dict``              |                |                                                                                                                     |

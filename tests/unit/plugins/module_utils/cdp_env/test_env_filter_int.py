...
def test_df_service_yml_public_subnet_filtering(sample_subnets):
    """
...
def test_df_service_private_cluster_setup(sample_subnets):
...
def test_df_service_mixed_setup(sample_subnets):
...
def test_multi_az_deployment(sample_subnets):
...
def test_cidr_range_validation(sample_subnets):
...
def test_combining_multiple_filters(sample_subnets):

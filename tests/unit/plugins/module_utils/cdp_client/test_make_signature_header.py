...
def test_make_signature_header_basic(mocker):
    ...
    mock_create_header.assert_called_once_with(b"mock_encoded_params", "mock_signature_value")
...
def test_make_signature_header_exactly_44_chars(mocker):
    ...
    mock_create_canonical.return_value = "PUT\n\nMon, 01 Jan 2024 00:00:00 GMT\n/api/v1/update\ned25519v1"
...
def test_make_signature_header_realistic_values(mocker):
    ...
    assert result == "eyJhY2Nlc3Nfa2V5X2lkIjoiMTc3ZTlhNDMtMjY3Zi00YjRlLWI0N2UtMDhiZTBlMTAzYWRlIiwiYXV0aF9tZXRob2QiOiJlZDI1NTE5djEifQ.kJ8VH2aM9p1Qz7X3nR5tY8uI2oP6wE4rT1yU9iO7pA"
...
def test_make_signature_header_final_header_error_propagation(mocker):
    ...
    mock_create_header.side_effect = UnicodeDecodeError("utf-8", b"", 0, 1, "invalid start byte")
